...
| --------------------------------- | ----------------------- | --------------------------------------------- | -------------------------- |
| *Information is....*              | ***A thing***           | ***an inductive index***                      | ***Symbolic Computation*** |
| *Cognition is...*                 | Irrelevant              | Intuitive statistics & epistemic formal logic | Symbolic manipulation      |
| *Learning is....*                 | Purchase of a commodity | Statistical inference                         | algorithm augmentation     |
| *Communication is...*             | The same as exchange    | "Signalling"                                  | Information transmission   |
| *Information is generated in....* | The Past                | The Future                                    | Now                        |
...
- The [[Ontology]] of this world is given and fixed prior to the analysis and is not altered by the activities of the knower, this resembles the ***block universe of relativistic physics*** where past/present/future coexist simultaneously in the state space 
...
- Under this model, [[Neoclassical Economics]] started to conflate any problem with information with some version of generic choice under uncertainty 
