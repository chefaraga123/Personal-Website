    ...
    return (
        <div className={styles.homeContainer}>
            ...
            <section className={styles.recentUpdates}>
                ...
                <p><span>15/05/2025: <a href="/article/Managerial-Ethics">Managerial Ethics & Ethical Micro-Management</a></span><Tag label="Article" /></p>
                <p><span>10/05/2025: <a href="/article/Who_set_the_prices_Who_Who">Who set the prices? Who. Who.</a></span><Tag label="Article" /></p>
                <p><span>14/04/2025: <a href="/article/Autonomous_Weapons">The weapons were always autonomous</a> which is about the cybernetic origins of autonomous weapons and their implications for modern warfare</span><Tag label="Article" /></p>
                ...
                <p><span>18/03/2025: <a href="/article/AI_Thinks_Like_The_Market">AI Thinks Like The Market</a> Financial Markets and Large Language Models share failure modes</span><Tag label="Article" /></p>
                <p><span>08/03/2025: <a href="/article/Soviet_Collapse">How Gorbachev's reforms collapsed the Soviet Union</a></span><Tag label="Article" /></p>
                ...
                <p><span>06/02/2025: <a href="/article/Marketplace-of-Ideas">Marketplace of Ideas</a> which is about the divergent epistemic committments of science and efficient markets</span><Tag label="Article" /></p>
            </section>
        </div>
    );
};
